            ...
            <section id="about">
                <div className="about-container">
                    ...
                    <p id="about-paragraph">      
                            Currently a <span className="highlight">Masters student</span> at University of Bergen and pursuing my master in <span className="highlight">Media and Interaction Design.</span><br/> 
                    ...
                    <p id="about-interests">
                        I have also artistic interest in <span className="highlight">fashion and style</span>. <br/>
